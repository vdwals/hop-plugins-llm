...
@Transform(id = "AIClassification", image = "AIClassification.svg", name = "AI Classification",
    description = "i18n::AIClassification.Description",
    categoryDescription = "i18n:org.apache.hop.pipeline.transform:BaseTransform.Category.Lookup",
    keywords = "i18n::AIClassificationMeta.keyword")
public class AIClassificationMeta extends LlmPluginMeta<AIClassification, AIClassificationData> {
  ...
  public AIClassificationMeta() {
    super();
    this.lookupValues = new ArrayList<>();
  }

  public AIClassificationMeta(AIClassificationMeta m) {
    super(m);
  ...
  @Override
  public AIClassificationMeta clone() {
    return new AIClassificationMeta(this);
  }
