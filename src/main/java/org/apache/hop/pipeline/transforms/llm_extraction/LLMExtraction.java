...
import org.apache.hop.pipeline.transforms.llm_extraction.LLMExtractionMeta.SLookupValue;
 ...
 * stream
 */
public class LLMExtraction extends BaseTransform<LLMExtractionMeta, LLMExtractionData> {
  private static final Class<?> PKG = LLMExtractionMeta.class; // For Translator

  public LLMExtraction(TransformMeta transformMeta, LLMExtractionMeta meta,
      LLMExtractionData data, int copyNr, PipelineMeta pipelineMeta, Pipeline pipeline) {
